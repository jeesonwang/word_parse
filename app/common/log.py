...
def register_logger():
    ...
    logger.add("./log/info_{time:%Y-%m-%d}.log", level="INFO", colorize=False, rotation="1 days", retention="7 days",
               backtrace=False, diagnose=False, encoding="utf-8")
    logger.add("./log/error_{time:%Y-%m-%d}.log", level="ERROR", colorize=False, rotation="1 days", retention="15 days",
               backtrace=False, diagnose=False, encoding="utf-8")
    logger.add("./log/error_detail_{time:%Y-%m-%d}.log", level="ERROR", colorize=False, rotation="1 days",
